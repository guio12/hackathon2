...
class OW_Match
{
    ...
    {
        $this->playedMaps = new \Doctrine\Common\Collections\ArrayCollection();
    }
     ...
     * @return OW_Match
     */
    public function addPlayedMap(\AppBundle\Entity\PlayedMap $playedMap)
    {
        $this->playedMaps[] = $playedMap;
